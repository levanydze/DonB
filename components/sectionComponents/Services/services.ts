export const categories = ["Restaurant", "Construction", "Gardening", "Other"];
...
export const services = [
  ...
  },
  {
    category: ["Restaurant"],
    title: "Logo Creation",
    text: "Designing visually appealing logos to represent the unique brand of your restaurant.",
  },
  {
    category: ["Construction"],
    title: "Logo Creation",
  ...
  },
  {
    category: ["Construction"],
    title: "Design For Any Devices",
    text: "Creating responsive websites that work flawlessly for construction industry professionals on any device.",
  },
  {
    category: ["Gardening"],
    title: "Design For Any Devices",
    text: "Designing responsive websites that make garden and landscape portfolios accessible on any device.",
  },
  {
    category: ["Other"],
    title: "Design For Any Devices",
